...
![image-20260114160029434](assets/3693258-20260114160354300-1336996224-1774611823946-258.png)
...
graph TB
    ...
    subgraph SE_Block [Squeeze-and-Excitation Block]
        ...
        %% 路径 A: 权重生成路径 (Squeeze & Excitation)
        Input --> GAP
        GAP -->|1×1×C| FC1
        FC1 -->|1×1×C/r| ReLU
        ReLU --> FC2
        ...
        %% 路径 B: 原始特征路径 (直接连到 Scale)
        %% 为了美观，通常画在侧边，但在垂直流中直接连即可
        Input -->|原始特征路径| Scale
